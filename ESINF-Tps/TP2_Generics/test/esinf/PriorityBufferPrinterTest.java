...
public class PriorityBufferPrinterTest {
    ...
    public void testGetDocument() {
        ...
        // make an ordered copy of setDoc
       
        ArrayList<Document> orderedSetDoc = (ArrayList <Document>)setDoc.clone();
        Collections.sort(orderedSetDoc);
        
        for (int i=0; i<orderedSetDoc.size();  i++) {
            Document d = instance.getDocument();
            assertTrue("Documents should be the same", (d.compareTo(orderedSetDoc.get(i))==0));
        }
    }
